...
public class RabbitMQErrorConfig {
     ...
     * 异常交换机
     */
    private String shortLinkErrorExchange;
    /**
     * 异常消息队列
     */
    private String shortLinkErrorQueue;
    /**
     * 异常消息的routingKey
     */
    private String shortLinkErrorRoutingKey;
    ...
    public Queue errorQueue() {
        return new Queue(shortLinkErrorQueue, true, false, false);
    }
