...
public class RabbitMQErrorConfig {
    ...
    public Queue errorQueue() {
        return new Queue(orderErrorQueue, true, false, false);
    }
    ...
    public Binding ErrorQueueAndExchangeBinding() {
        return new Binding(orderErrorQueue, Binding.DestinationType.QUEUE, orderErrorExchange, orderErrorRoutingKey, null);
    }
